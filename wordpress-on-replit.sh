...
sed -i 's~/* Add any custom values between this line and the "stop editing" line. */~/* Add any custom values between this line and the "stop editing" line. *\~n$_SERVER[ "HTTPS" ] = "on";~' ./wordpress/wp-config.php
